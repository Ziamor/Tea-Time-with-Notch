    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        else if (var6 == 3)
        {
            for (var8 = 0; var8 >= -1; --var8)
            {
                ...
                {
                    if (this.func_50076_f(par1World, par2 + var8, par3, par4 + var9, 3) && this.func_50076_f(par1World, par2 + var8 + 1, par3, par4 + var9, 3) && this.func_50076_f(par1World, par2 + var8, par3, par4 + var9 + 1, 3) && this.func_50076_f(par1World, par2 + var8 + 1, par3, par4 + var9 + 1, 3))
                    {
