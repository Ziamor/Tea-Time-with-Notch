...
public class AnvilChunkLoader implements IThreadedFileIO, IChunkLoader
{
    ...
    {
        DataOutputStream var2 = RegionFileCache.getChunkOutputStream(this.chunkSaveLocation, par1AnvilChunkLoaderPending.field_48427_a.chunkXPos, par1AnvilChunkLoaderPending.field_48427_a.chunkZPos);
    ...
    private Chunk readChunkFromNBT(World par1World, NBTTagCompound par2NBTTagCompound)
    {
        ...
        var5.heightMap = par2NBTTagCompound.func_48182_l("HeightMap");
